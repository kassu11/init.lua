...
vim.keymap.set({ "i", "c" }, "<M-l>", "<Right>", { desc = "Move right in insermode" })
vim.keymap.set({ "i", "c" }, "<M-h>", "<Left>", { desc = "Move left in insermode" })
vim.keymap.set({ "i", "c" }, "<C-l>", "<Del>", { desc = "Delete character under cursor" })
