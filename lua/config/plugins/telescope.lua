return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>st", function() builtin.live_grep { glob_pattern = { "*.scss", "*.css" } } end, { desc = "Search grep inside css files" })
      vim.keymap.set("n", "<leader>sw", builtin.grep_string, { desc = "Search current Word" })
      vim.keymap.set("n", "<leader>sg", builtin.live_grep, { desc = "Search by Grep" })
      vim.keymap.set("n", "<leader>s<S-g>", function() builtin.live_grep {search_dirs={vim.fn.expand("%:p")}} end, { desc = "Search by Grep" })
